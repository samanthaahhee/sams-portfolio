...
/* Always render fresh — never cache. The page is gated by the admin
 * cookie so we want the cookie check to run per request. */
...
export default async function AboutPage() {
  /* Gate: visible only when the admin session cookie is present, or
   * when running in development. Public visitors get a 404. The page
   * stays buildable / iterable without being live. */
