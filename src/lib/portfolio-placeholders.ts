...
export const PLACEHOLDER_PROJECTS: PortfolioProject[] = [
  {
    ...
    role: "Brand Designer", year: "2023", orderIndex: 0, visible: true, showHero: true, workGridTemplate: null, accentColor: null, overviewHeading: null, overviewBody: null,
    coverUrl: PH_COVERS[0], coverType: "image", thumbUrl: null, thumbFocalX: 0.5, thumbFocalY: 0.5, thumbZoom: 1,
    coverFocalX: 0.5, coverFocalY: 0.5, coverZoom: 1,
  ...
  // the legacy /work/bos-ice-tea page) — not invented placeholder text.
  {
    ...
    role: "Senior Art Director (EMEA region)", year: "2018–2019", orderIndex: 1, visible: true, showHero: true, workGridTemplate: null, accentColor: null, overviewHeading: null, overviewBody: null,
    coverUrl: PH_COVERS[1], coverType: "image", thumbUrl: null, thumbFocalX: 0.5, thumbFocalY: 0.5, thumbZoom: 1,
    coverFocalX: 0.5, coverFocalY: 0.5, coverZoom: 1,
  ...
  },
  {
    ...
    role: "Visual Comms Design", year: "2024", orderIndex: 2, visible: true, showHero: true, workGridTemplate: null, accentColor: null, overviewHeading: null, overviewBody: null,
    coverUrl: PH_COVERS[2], coverType: "image", thumbUrl: null, thumbFocalX: 0.5, thumbFocalY: 0.5, thumbZoom: 1,
    coverFocalX: 0.5, coverFocalY: 0.5, coverZoom: 1,
  ...
  },
  {
    ...
    role: "Brand Designer", year: "2024", orderIndex: 3, visible: true, showHero: true, workGridTemplate: null, accentColor: null, overviewHeading: null, overviewBody: null,
    coverUrl: PH_COVERS[3], coverType: "image", thumbUrl: null, thumbFocalX: 0.5, thumbFocalY: 0.5, thumbZoom: 1,
    coverFocalX: 0.5, coverFocalY: 0.5, coverZoom: 1,
  ...
  // one of the five with its own first-person description already written.
  {
    ...
    role: "Brand Designer", year: "2025", orderIndex: 4, visible: true, showHero: true, workGridTemplate: null, accentColor: null, overviewHeading: null, overviewBody: null,
    coverUrl: PH_COVERS[4], coverType: "image", thumbUrl: null, thumbFocalX: 0.5, thumbFocalY: 0.5, thumbZoom: 1,
    coverFocalX: 0.5, coverFocalY: 0.5, coverZoom: 1,
...
function media(url: string, w: number, h: number, order: number): PortfolioMedia {
  return {
    ...
    gridColStart: null, gridColSpan: 1, gridRowStart: null, gridRowSpan: 1, frameIndex: 0, focalX: 0.5, focalY: 0.5, zoom: 1,
  };
}
